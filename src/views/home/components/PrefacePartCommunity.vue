<template>
  <div class="preface_part">
    ...
    <div class="content_box">
      ...
      <p class="text1 invisible communityPrefaceTwo">
        {{ prefacePartData.text1 }}
      </p>
      <p :class="contentClass" class="text1 text2 invisible communityPrefaceTwo">
  ...
  if (newVal === 'communityPrefacePart') {
    ...
    Promise.all([imagePromise]).then(() => {
      setTimeout(() => {
        ...
        setTimeout(() => {
          animateCSS('.communityPrefaceTwo', ['animate__fadeIn', 'animate__slow'], 0, false, true)
        }, 700)
      }, 1200)
    })
  }
